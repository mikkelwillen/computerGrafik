...
glm::vec3 Vertices[] = {
    ...
    //dennyetrakant1.png
    //glm::vec3(-33.978017f, -14.985076f,  50.214926f),
    //glm::vec3( 84.192943f, -13.784394f, -50.214926f),
    //glm::vec3(-16.236910f,  83.754546f, -50.214926f)

    //dennyetrakant2.png
    //glm::vec3(-33.978017f, -53.985076f,  50.214926f),
    //glm::vec3( 84.192943f, -13.784394f, -90.214926f),
    //glm::vec3(-16.236910f,  63.754546f, -30.214926f)

    //patrick trekant
    //glm::vec3(-33.978017f, -34.985076f,  50.214926f),
    //glm::vec3( 34.192943f, -13.784394f, -30.214926f),
    //glm::vec3(-26.236910f,  83.754546f, -50.214926f)
...
int main()
{
    try {
        ...
        // Der laver han et program der der loaded phong og vert ind på gpuen
...
https://www.overleaf.com/project/6152cf47b6d95710f1b243b6
            glfwPollEvents();
        }
    }
